...
class LiveRepositoryImpl @Inject constructor(
    ...
    override suspend fun getCallToken(sessionId: String, memberUuid: String): Resource<CallToken> =
        wrapToResource {
            liveRemoteDataSource.getCallToken(sessionId, CallTokenRequest(memberUuid, sessionId)).toDomainModel()
        }
}