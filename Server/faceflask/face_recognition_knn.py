        ...
        for img_path in image_files_in_folder(os.path.join(train_dir, class_dir)):
            ...
            if len(face_bounding_boxes) != 1:
                ...
                if verbose:
                    ...
                    print("Image {} not suitable for training: {}".format(img_path, "얼굴을 찾지 못함" if len(face_bounding_boxes) < 1 else "얼굴이 2개 이상"))
            else:
...
if __name__ == "__main__":
    ...
    classifier = train("knn_examples/train/wonill", model_save_path="trained_knn_model.clf", n_neighbors=None)
            ...
            if hasattr(pil_image, '_getexif'):
                ...
                if exifdata is not None:
                    ...
                    if orientation == 3:
                        ...
                        pil_image = pil_image.transpose(Image.ROTATE_90)
                    pil_image.save(full_file_path, quality=100)
        except:
            pass
